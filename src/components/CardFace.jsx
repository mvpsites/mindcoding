  ...
  return (
    <svg viewBox="0 0 220 376" className="mc-facesvg" role="img" aria-label={card.name}>
      ...
      <g stroke="var(--gold)" strokeWidth="0.8" opacity="0.8">
        ...
        <line x1="52" y1="304" x2="98" y2="304" />
        <line x1="122" y1="304" x2="168" y2="304" />
        <polygon points={starPts(110, 304, 4, 1.6, 4)} fill="var(--gold)" stroke="none" />
      </g>
      {card.art ? (
        <image
      ...
      <text x="110" y="332" textAnchor="middle" fill="var(--ivory)" fontFamily="Cinzel, serif" fontSize="12.5" letterSpacing="3">
        {card.name.toUpperCase()}
      </text>
      {card.suit !== "Major Arcana" && (
        <text x="110" y="348" textAnchor="middle" fill="var(--gold)" fontFamily="Cinzel, serif" fontSize="7.5" letterSpacing="3" opacity="0.8">
          {card.suit.toUpperCase()}
        </text>
      )}
      <g transform="translate(110, 358)" opacity="0.85">
